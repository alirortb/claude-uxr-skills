...
- **[`eow-summary`](./eow-summary/)** — Generate an end-of-week summary by scanning Claude Code transcripts, git activity across configurable scan roots, `~/dev/deliverables/` entries, and project memory. Produces a layered draft (personal log, team digest, AI Design Guild candidates) for editing before sharing.
